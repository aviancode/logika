...
use orbita_core::{NodeId, PluginId, PortId};
...
pub const CURRENT_API_VERSION: &str = "orbita.dev/v1";
...
pub enum ApiVersion {
    ...
    V1Alpha1,
    /// The stable workflow document format for Orbita 0.1.
    V1,
}
...
impl ApiVersion {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::V1Alpha1 => "orbita.dev/v1alpha1",
...
impl FromStr for ApiVersion {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value {
            "orbita.dev/v1alpha1" => Ok(Self::V1Alpha1),
...
/// A canonical `orbita.dev/v1` workflow document.
