//! In-memory node registry and future plugin registry contracts for `orbita`.

#![forbid(unsafe_code)]

use std::collections::BTreeMap;

use orbita_core::{Error, ErrorCategory, ErrorDetail, PluginId, Result, TypeRef};
use orbita_workflow::{NodeInterface, NodeReference, TypeReference, ValidationResolver};
use semver::Version;
