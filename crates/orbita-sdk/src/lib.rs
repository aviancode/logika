//! Rust SDK for defining typed `orbita` nodes and workflows.
//!
...
extern crate self as orbita_sdk;
...
pub use orbita_core::Schema;
use orbita_core::{IdentifierError, NodeId, PortId, SchemaError};
pub use orbita_sdk_macros::Schema;
use orbita_workflow::{
...
impl WorkflowBuilder {
    ...
    ///
    /// ```compile_fail
    /// use orbita_sdk::{Input, Output, WorkflowBuilder};
    ///
    /// struct Order;
    /// struct Customer;
    ///
